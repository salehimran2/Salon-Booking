...
define('ACCOUNT_CONTROLLER',        'account');
define('UPDATES_CONTROLLER',        'updates');
define('SERVICE_CONTROLLER',        'service');
define('CONTACT_CONTROLLER',        'contact');
define('CLIENTS_CONTROLLER',        'clients');
define('GALLERY_CONTROLLER',        'gallery');
define('OAUTH_CONTROLLER',          'oauth');
define('BOOKINGS_CONTROLLER',       'bookings');
define('LAYOUT_CONTROLLER',         'layout');
define('HOMEPAGE_CONTROLLER',       'homepage');
define('ADMINBLOG_CONTROLLER',      'adminblog');
define('BLOG_CONTROLLER',           'blog');
define('INVOICE_CONTROLLER',        'invoice');
define('PAYMENTS_CONTROLLER',       'allpayments');
define('AGENTS_CONTROLLER',         'agents');
