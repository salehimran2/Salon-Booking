               ...
               <div class="card">
				  ...
				  <form action="<?php anchor_to(ADMINBLOG_CONTROLLER . '/edit_post/'.$postData['id']); ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<input class="form-control" type="text" id="title" name="title" placeholder="Choose Image Title" value="<?php echo esc(set_value('title', $postData['title']), true)?>">
								</div>
								<div class="form-group">
									<label for="description">Description <span class="text-danger">*</span></label>
									<?php echo form_error('description', '<br><span class="text-danger">', '</span>'); ?>
									<textarea id="service-content" name="description" class="form-control" placeholder="Choose Image Short Description"><?php echo esc(set_value('description', $postData['description']), true)?></textarea>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="custom-control custom-switch">
										<input <?php echo (isset($postData['status']) ? ($postData['status'] == 1 ? "checked" : null) : "checked"); ?> id="status-check" name="status" type="checkbox" class="custom-control-input">
					...
					<div class="card-action">
						...
						<button type="submit" class="btn btn-success"><i class="fas fa-check mr-1"></i> Update Blog Post</button>
					</div>
				  </form>
               </div>
            </div>
